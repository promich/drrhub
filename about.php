...
<section class="bg-primary-alt o-hidden">
      <div class="container">
        <div class="row layer-2 justify-content-between min-vh-50">
           <div class="col-md-4 aos-init aos-animate" data-aos="fade-left">
	        <img src="assets/img/resilience.jpg" alt="Photo: UN Photo/Harandane Dicko" class="img-round">
          </div>
          <div class="col-md-7">
	         <h1 class="display-4">Introducing the Disaster Risk Reduction Media Hub</h1>
              <p class="leader mb-3">When the coronavirus disease pandemic brought the world to a halt in 2020, it affected every aspect of human life around the world and exemplified the scale and range of problems that disasters bring in their wake.</p> 
              <p class="leader mb-5">Its global impact highlights the urgency and importance of concerted planning and collective action to reduce disaster risk and build resilience.</p>
...
Journalists often specialize in areas such as economics, education or health. However, disaster risk reduction (DRR) or fostering disaster resilience is seldom considered a beat worthy of similar attention. This handbook addresses reporters and broadcasters who want to know more about those urgent, terrifying and all-too-often tragic moments when a populated built environment is challenged by the forces of nature or a man-made disaster. It draws upon the expertise of journalists, disaster experts and researchers to take a comprehensive and systemic approach. It emphasises the multidimensional and interconnected nature of the risks we face and puts forward a blend of practical information, professional approaches and underlying principles for the effective reporting of disasters. 
        ...
        <div class="decoration middle-y middle-x scale-dot25 d-none d-xl-block" data-jarallax-element="60">
          <img class="bg-white" src="assets/img/covid-19.svg" alt="deco-dots-4 decoration" data-inject-svg />
        </div>
        <div class="decoration top right scale-dot5" data-jarallax-element="80">
          <img class="bg-white" src="assets/img/covid-19.svg" alt="" data-inject-svg />
        </div>
      </div>
